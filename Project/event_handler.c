...
void EXTI_init(void)
{
	...
	EXTI->IMR |= EXTI_IMR_MR0 | EXTI_IMR_MR1 | EXTI_IMR_MR2 /*| EXTI_IMR_MR3*/ | EXTI_IMR_MR12;
	EXTI->FTSR |= EXTI_FTSR_TR0 | EXTI_FTSR_TR1 | EXTI_FTSR_TR2 /*| EXTI_FTSR_TR3*/ | EXTI_FTSR_TR12;
